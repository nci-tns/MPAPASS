function [CollatedData,SelectedColumnNames, SelectedRowNames, SelectedInfo, SelectedLabelInfo, Selection, errormess] = MPA_SampleIndex_v3(Database, CustomVariableIndex, CustomVariablesItemIndex, CustomVariableHeadersListbox, SamplesListBox, GroupsListBox, AbMixesListBox, CaptureAbListBox, AbSelectionItemIndex, MarkerLabelsListBox, SampleLabelsListBox)
...
for i = 1:numel(IndexedSampleID)
    ...
    for ii = 1:numel(IndexedMixNum)
        ...
        for iii = 1:numel(AbInd)
            ...
            TempSelectedRowNames = strcat(Database.Beads.Bead_CaptureAntibody_Target(BeadInd), {', '}, LabelNames{iii});
        ...
        if  i == 1
            SelectedRowNames = vertcat(SelectedRowNames, TempSelectedRowNames);
        end
